...
(function() {
	...
	const BULBS = [
		...
		/* Floower */
		{
			...
			'write':	{
				'service':			'28e17913-66c1-475f-a76e-86b5242f4cec',
				'characteristic':	'11226015-0424-44d3-b854-9fc332756cbf',
				'format':			(r, g, b) => new Uint8Array([ 0x00, r, g, b, 0x00, 0x01 ])
			},
			
			'read': {
				'service':			'28e17913-66c1-475f-a76e-86b5242f4cec',
				'characteristic':	'ac292c4b-8bd0-439b-9260-2d9526fff89a',
				'interpret':		(buffer) => buffer.byteLength == 4 ? new Object({ r: buffer.getUint8(1), g: buffer.getUint8(2), b: buffer.getUint8(3) }) : new Object({ r: 0, g: 0, b: 0 })
			}
		},
